        ...
        <div className="body">
            <div className="body-container">
                ...
                <div className="body-download">
                   <a href="https://drive.google.com/file/d/1K-oVN3cKVzkCD4j7eJuEJ4vPUOnGZGS2/view?usp=sharing" target="_blank"> <button ><div className="download"><i><AiOutlineDownload fontSize="1.5rem"  / ></i> Download CV</div></button></a>
                </div>
            </div>
        </div>
    )
